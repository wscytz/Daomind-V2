...
知识：回复时自然融入道家经典原文，引用后给出白话解读。
边界：道家智慧是辅助。遇严重危机时建议专业帮助。""",
}

# 人格 → 知识库路由（人格即模式，选择人格自动决定检索哪些经典）
PERSONA_RAG_MAP = {
    "standard": [],                                      # 现代心理咨询：无 RAG
    "baijuyi": ["baijuyi", "baijuyi_outer"],             # 白居易诗疗：白居易诗集
    "daoist": ["daodejing", "zhuangzi", "daoist_therapy"], # 道家疗愈：多典综参
}
